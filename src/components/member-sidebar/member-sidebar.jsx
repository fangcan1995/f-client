        ...
        <div className="sidebar">
            <div className="sideMenu">
                ...
                <div className="sideMenu__nav">
                    <h3><i className="icon icon-all"></i>账户总览</h3>
                    <ul>
                    ...
                    <h3><i className="icon icon-invest"></i>我的投资</h3>
                    <ul>
                        <li><a href="#">我的投资</a></li>
                        <li><a href="#">回款记录</a></li>
                    </ul>
                    <h3><i className="icon icon-myloan"></i>我的借款</h3>
                    <ul>
                        <li><a href="#">我的借款</a></li>
                        <li><a href="#" >还款计划</a></li>
                    </ul>
                    ...
                    <h3><i className="icon icon-setting"></i>基本设置</h3>
                    <ul>
                        <li><a href="#">个人资料</a></li>
                        <li><a href="#">认证中心</a></li>
                        <li><a href="#">风险评估</a></li>
