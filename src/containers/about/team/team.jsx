                    ...
                    <ul className="speciallist">
                        ...
                        <li>
                            <dl>
                                ...
                                <dd className="intro">
                                    <p>
                                        毕业于东北财经大学金融专业，曾任职&ldquo;新商报&rdquo;编辑，行动成功管理技术有限公司市场总监；誉霖鼎信财富管理(大连）有限公司总经理助理天元承汽车用品有限公司。中国优秀职业经理人。多年的团队管理和市场营销经验，在业界享有高度的赞誉，获得多项荣誉称号，得到了上级和社会的一致认同。
                                    </p>
                                </dd>
                            </dl>
                        </li>
                        ...
                        <li>
                            <dl>
                                ...
                                <dd className="photo"><img src={require('../../../assets/images/about/phone6.jpg')} /></dd>
                                <dd className="intro">
                                    <p>
