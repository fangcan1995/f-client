...
class RateCoupons extends React.Component{
    ...
    dataSet={
        "url":`http://localhost:9002/members/rateCoupons`,
        "pageNum":1,
        "pageSize":10,
        "filter":{
            re_status:0,
        ...
        jQuery.ajax({
            ...
            let resource={
                ...
                "data": {
                    ...
                    "total": 23,
                    "list":[
                        { 'col1':'现金加息券','col2':'0.8','col3':'3个月定期产品满1000元可用','col4':'2017.01.22','col5':'2017.02.06'},
                        { 'col1':'现金加息券','col2':'2.58','col3':'3个月定期产品满1000元可用','col4':'2017.01.22','col5':'2017.02.06'}
                    ]
                },
        }
